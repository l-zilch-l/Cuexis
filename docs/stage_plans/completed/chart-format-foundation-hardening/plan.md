...
状态：completed；R0-R5 全部完成（D1-D10 已裁定，A19/A20/A21/A22 已修复），本地回归矩阵、
容量复跑与同 SHA hosted 三平台验证（报告 SHA `e0ca9ff`，docs-only 复验 `c24f34e`）全绿，
owner 于 2026-09-17 接受 [R5 交接清单](../../../stage_reports/stages/chart-format-foundation/2026-09-17-r5-regression-and-handoff.md)；
Stage 6 已恢复 active
...
| R5 | 完成；本地回归矩阵（六个配置全绿）、A19/A20/A21/A22 修复（实现 SHA `9314646`）、容量复跑、关闭报告、同 SHA hosted 三平台验证（报告 SHA `e0ca9ff`：Linux Quality `35309906143`、Windows MSVC `35309906142`、Windows MinGW `35309906141` 全部成功）与 docs-only 复验（`c24f34e`，Linux `35312093769`、MSVC `35312093775`、MinGW `35312093806`）全部完成；owner 于 2026-09-17 接受 R5 交接清单，本计划归档、Stage 6 恢复 active | [R5 报告](../../../stage_reports/stages/chart-format-foundation/2026-09-17-r5-regression-and-handoff.md)、[容量数据 Debug](../../../stage_reports/stages/chart-format-foundation/2026-09-17-r5-capacity-data.json)、[容量数据 Release](../../../stage_reports/stages/chart-format-foundation/2026-09-17-r5-capacity-data-release.json)、6 个配置的全量 CTest 记录、hosted run `35253027313`/`35253027357`/`35253027366`/`35258433569`/`35258433530`/`35258433516`/`35309906143`/`35309906142`/`35309906141`/`35312093769`/`35312093775`/`35312093806` | 已达成 |
