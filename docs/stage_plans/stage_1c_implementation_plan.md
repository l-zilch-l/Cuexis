...
通用 `Curve<T>`、新增 easing、循环、Material、Visibility、ParentBinding 和 BehaviorClip 组合留在阶段 2。阶段 2 通过新的 Behavior version 扩展，不静默改变 version 1 的采样结果。
...
通用 Curve<T>、新增 easing、循环、BehaviorClip 组合
