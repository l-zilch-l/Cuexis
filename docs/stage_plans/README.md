...
| [Stage 5](stage_5_implementation_plan.md) | future; S5-A frozen; S5-B wired; S5-C/S5-D/S5-E/S5-F/S5-G complete | Material、Shader 与能力 Profile；S5-A 合同已冻结；S5-B 已接线；S5-C 已完成；S5-D 已完成；S5-E 已完成；S5-F 已完成；S5-G 已完成；S5-H 尚未开始 |
