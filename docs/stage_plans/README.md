...
| [Stage Chart Format Update](stage_chart_format_update_implementation_plan.md) | active, implementation blocked | CXC、Chart v4、CXT 收口决策与 CFU-C 至 CFU-G 详细执行计划；等待 ADR 0038 整体接受 |
