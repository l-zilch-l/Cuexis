...
- [Stage 6](active/stage-06/plan.md)：**当前阶段，2026-09-17 启动（首批 S6-A）**，以 Chart v5
  ...
  2026-09-20 已细化子批次依赖、阻塞决策和验收矩阵；当前仍从 S6-A 基线与合同门禁推进，
  八项关键决策已在 [ADR 0042](../adr/0042-stage-6-productization-boundaries.md) 冻结，
  A2 负责合同落盘与表征，不再自行选择架构。设计冻结不表示相关功能已经实现。
