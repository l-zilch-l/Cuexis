...
| [Stage Chart Format Update](stage_chart_format_update_implementation_plan.md) | active | C0–C4 complete；CFU-D/CFU-E/CFU-F 已关闭；G3 hosted 与 G4 complete；G5/G6 pending |
