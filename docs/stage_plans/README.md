...
| [Stage Chart Format Update](stage_chart_format_update_implementation_plan.md) | active | C0–C4 complete；CFU-D/CFU-E/CFU-F 已关闭；已推进至 G4 readiness，G3 hosted pending |
