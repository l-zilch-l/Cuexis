...
| [Stage Chart Format Update](stage_chart_format_update_implementation_plan.md) | active | C0–C4 complete；CFU-D/CFU-E/CFU-F 已关闭；G5 report candidate 已创建，report-SHA hosted/G6 pending |
