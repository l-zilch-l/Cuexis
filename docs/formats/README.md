...
| Chart v4 | [CHART_V4_FORMAT.md](../CHART_V4_FORMAT.md) | accepted contract; C1–C4 implemented; CFU-D lift/equivalence/close complete; CFU-E static/parameterized prepare and identity closed |
...
记录“未提供外部资产”并关闭；兼容窗口不缩短。最终 hosted
产品门禁仍未关闭；该检查点不是完整 CXC 产品支持或公共 package API。评审示例位于
