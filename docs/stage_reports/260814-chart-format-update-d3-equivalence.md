...
后续关闭：[CFU-D 关闭报告](260814-chart-format-update-d-close.md) 已按项目所有者“未提供外部资产”决策关闭整包 CFU-D；兼容窗口不缩短。本文件仍是 D3 快照。

权威计划：[Stage Chart Format Update 实施计划](../stage_plans/stage_chart_format_update_implementation_plan.md) §5.6

结构基线：[CFU-D1/D2 报告](260813-chart-format-update-d-migration.md)

Playback 基线：[CFU-E 关闭报告](260814-chart-format-update-e-close.md)
