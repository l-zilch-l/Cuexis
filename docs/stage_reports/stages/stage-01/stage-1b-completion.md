...
**SDK 转型补充（2026-07-20）**：阶段 1C 同时交付第一版 PlaybackSession C++ 门面、宿主直接提交 RuntimeFrame 的 headless 路径和 FrameSnapshot 输出，Player 改为 PlaybackSession 的薄组合层。详见[阶段 1C 实施计划](../../../stage_plans/completed/stage-01/stage-1c-plan.md)与 [SDK 转型方案](../../../stage_plans/historical/sdk-transition/plan.md) §12.1。
...
- [阶段 1B 实施计划](../../../stage_plans/completed/stage-01/stage-1b-plan.md)
- [构建与验证](../../../guides/BUILDING.md)
- [RuntimeSession 规范](../../../architecture/RUNTIME_SESSION.md)
