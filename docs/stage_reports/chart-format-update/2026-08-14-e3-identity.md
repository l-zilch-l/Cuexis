...
后续关闭：[CFU-E4 报告](2026-08-14-e4-gates.md) 已取得本地全量门禁数字。[CFU-E 关闭报告](2026-08-14-e-close.md) 已由项目所有者接受整包 CFU-E。
...
Prepare 基线：[CFU-E2 报告](2026-08-14-e2-prepare.md)

Combiner 合同：[CHART_V4_FORMAT.md](../../formats/CHART_V4_FORMAT.md) §3
...
最终 digest 是 [CHART_V4_FORMAT.md](../../formats/CHART_V4_FORMAT.md) 冻结的域分隔 SHA-256：
