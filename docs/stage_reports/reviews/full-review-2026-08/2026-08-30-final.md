...
| 项目 | 值 |
| --- | --- |
| 原始审查报告 | [`260829-full-review.md`](2026-08-29-review.md) |
...
| 决策 | 结果 | 证据 |
| --- | --- | --- |
| D1 / PB-01 | Chart v4 renderable 要求 portable `CXPRES01`；legacy payload 稳定拒绝 | [D1/D2 报告](2026-08-29-d1-d2.md)、ADR 0041 |
| D2 / CX-01 | record-level `extensions` 严格拒绝；document-level opaque extensions 保留 | [D1/D2 报告](2026-08-29-d1-d2.md)、ADR 0041 |
| D3 / PB-04 | `frame.value_invalid` 保留给 boundary/Validation Sink；extract 只发 non-finite | [D3-D6 报告](2026-08-30-d3-d6.md)、W30-W37 |
| D4 / CH-03 | 两参 TimingMap 保留 legacy 正 finite BPM；显式 limits 路径执行严格域 | [D3-D6 报告](2026-08-30-d3-d6.md) |
| D5 / RT-04 | `RenderFrame/renderFrame` 保留并标记 legacy/diagnostic-only | [D3-D6 报告](2026-08-30-d3-d6.md) |
| D6 | v1/v2/v3 PreparedSemanticIdentity 一次性迁移到完整 canonical Chart bytes | [D3-D6 报告](2026-08-30-d3-d6.md) |
