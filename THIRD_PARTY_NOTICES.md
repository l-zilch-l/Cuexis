...
This file is the source-tree notice inventory for the current Cuexis stage 1C tree. Versions below are resolved by the pinned vcpkg baseline `8e8dfb4ba483886936ded5ca201b500b8d8b0096`. Exact distributed transitive notices must be verified again before each release.
...
| fmt | 12.2.0 | https://github.com/fmtlib/fmt | Transitive formatting dependency of spdlog | MIT | Linked only when the selected spdlog package requires it | Follows the Player-private spdlog dependency |
